    ...
    <div className="model">
      ...
      <div className="model__details model__details-2">
        <div className="model__detail">
          ...
          <span className="model__details__text">{model.rating}/ 5</span>
        </div>
        <div className="model__detail model__detail-right">
          <FontAwesomeIcon icon={faCar} className="model__details__icon" />
          <span className="model__details__text">{model.fuel}</span>
        </div>
        <div className="model__detail">
          <FontAwesomeIcon icon={faCar} className="model__details__icon" />
          <span className="model__details__text">{model.make}</span>
        </div>
        <div className="model__detail model__detail-right">
          <FontAwesomeIcon icon={faCar} className="model__details__icon" />
          <span className="model__details__text">{model.transmission}</span>
        </div>
      </div>
      <button
